...
class PeThemeWooCommerce {
	...
	public function woocommerce_before_main_content() {	
		...
		printf('<div class="%s">',$sidebar ? "col-md-8" : "col-md-12");
	}
	...
	public function pe_theme_after_header() {
		if (function_exists('is_woocommerce') && is_woocommerce()) {
			print '<div class="site-body"><div class="pe-container pe-woocommerce"><div class="row">';
		}
	}
	...
	public function pe_theme_asset_style_pe_theme_init_deps_filter($deps) {
		if (file_exists(sprintf('%s/%s',PE_THEME_PATH,"css/woocommerce.css"))) {
