...
class PeThemeAsset {
	...
	public function registerAssets() {
		...
		$this->addScript("framework/js/pe/jquery.pixelentity.splash.js",array("jquery"),"pe_theme_splash");
		$this->addScript("framework/js/pe/jquery.pixelentity.widgets.splash.js",array("pe_theme_widgets","pe_theme_splash"),"pe_theme_widgets_splash");

		$this->addScript("framework/js/pe/jquery.pixelentity.360.js",array("jquery","pe_theme_three"),"pe_theme_360");
		$this->addScript("framework/js/pe/jquery.pixelentity.widgets.360.js",array("pe_theme_widgets","pe_theme_360"),"pe_theme_widgets_360");
		...
		$bsv = apply_filters("pe_theme_bootstrap_version","2.2.1");

		$this->addStyle("framework/js/bootstrap/$bsv/css/bootstrap.css",array(),"pe_theme_bootstrap");
		...
		$this->addScript(apply_filters("pe_theme_bootstrap_js","framework/js/bootstrap/$bsv/js/bootstrap.min.js"),array("jquery"),"pe_theme_bootstrap");
		...
		// menu
		$this->addStyle("framework/css/menu.css",array(),"pe_theme_menu");
		...
		// Three.js
		$this->addScript("framework/js/three.min.js",array(),"pe_theme_three");
		...
		// taglines
		$this->addScript("framework/js/pe/jquery.pixelentity.taglines.js",array("jquery"),"pe_theme_taglines");
		$this->addScript("framework/js/pe/jquery.pixelentity.widgets.taglines.js",array("pe_theme_taglines","pe_theme_widgets"),"pe_theme_widgets_taglines");
