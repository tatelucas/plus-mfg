		...
		return
			array(
				  ...
				  array(
						...
						"default" => sprintf(__('<p>Donec nec justo eget felis facilisis fermentum. Aliquam porttitor mauris sit amet orci. Aenean dignissim pellentesque felis.</p>','Pixelentity Theme/Plugin'),"\n")
						),
				  "address" =>
				  array(
						"label" => __("Address",'Pixelentity Theme/Plugin'),
						"type" => "Editor",
						"description" => __("Text appropriate for displaying your address.",'Pixelentity Theme/Plugin'),
						"default" => sprintf(__('<h5>AKUMA STUDIOS</h5>%s<p>Suite 11b<br>%s175 Broadway<br>%sNew York NY10015</p>','Pixelentity Theme/Plugin'),"\n","\n","\n")
						),
				  "contact_details" =>
				  array(
						"label" => __("Contact Details",'Pixelentity Theme/Plugin'),
						"type" => "Editor",
						"description" => __("Text appropriate for displaying contact Details.",'Pixelentity Theme/Plugin'),
						"default" => sprintf(__('<a href="mailto:howdy@akumastudios.com" class="email">howdy@akumastudios.com</a>%s<a href="#" class="phone">+12 345 678 90</a>','Pixelentity Theme/Plugin'),"\n")
						),
				  "submit" =>
				  array(
