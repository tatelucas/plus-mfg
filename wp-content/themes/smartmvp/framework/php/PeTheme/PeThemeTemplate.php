		...
		<div class="col-md-12">
			<form action="<?php $comments->action(); ?>" method="post" id="commentform">
				...
				<div class="form-group form-group-comment">
					<textarea class="form-control" id="comment" name="comment" cols="45" rows="8" aria-required="true" placeholder="<?php _e("Your comment here..",'Pixelentity Theme/Plugin'); ?>"></textarea>
				</div>
...
?>
<div class="<?php echo esc_attr( $classes ); ?>" <?php echo $all ?> data-msg="<?php _e("Load More",'Pixelentity Theme/Plugin'); ?>">
