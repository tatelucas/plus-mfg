...
"Large Banner",
"Button text",
"Text for optional button. Leave empty to not use the button.",
"Button url",
"Url button will link to.",
"Open in new window",
"Should the url be opened in new window?",
"Add a Large banner section.",
"Home Columns",
...
"Text appropriate for displaying your address.",
"<h5>AKUMA STUDIOS</h5>%s<p>Suite 11b<br>%s175 Broadway<br>%sNew York NY10015</p>",
"Contact Details",
"Text appropriate for displaying contact Details.",
"<a href=\"mailto:howdy@akumastudios.com\" class=\"email\">howdy@akumastudios.com</a>%s<a href=\"#\" class=\"phone\">+12 345 678 90</a>",
"Submit Label",
...
"Use this block to add a Video section.",
"Section title..",
"Section subtitle.",
...
"Team",
"Use this block to add a Team section.",
"Member",
"Social links",
"Add one or more icon.",
"TeamMember",
"Use this block to add a new team member.",
"Use this block to add a Tabs section.",
"Tab Title",
"Tab Title.",
"Icon.",
"Column Title",
"Column Title.",
"Layout 4",
"2 Columns text with a big image (bottom).",
"Section Title",
"Icons",
"Add one or more icons",
"Add New Icon",
"Layout 3",
"Text with icons and a big image (right).",
"Layout 2",
"Text with icons and a big image (left).",
"Button 1 text",
"Button 1 url",
"Button 2 text",
"Button 2 url",
"Layout 1",
"Text with buttons and a big image (right).",
"Section title.",
"Text displayed inside a button.",
"Handwritten text",
"Displayed next to a button.",
"Use this block to add a Follow Us section.",
"Use this block to add a Pricing section.",
"Plan",
"Pricing plan title.",
"Web Page",
"Plan price.",
"Optional ribbon text, like \"popular\" (leave empty for none).",
...
"Graph 1 text.",
"Values",
"Add one or more graph values",
"Add New Graph Value",
"Label %",
"Graph 2 label",
"Graph 2 text.",
"Use this block to add an Action section.",
"Follow Us",
"Add Icon",
"Use this block to add a Features section.",
"Name of this feature.",
"Icon link",
"Optional link which will be added to the icon.",
"Use this block to add a new feature.",
"Content subtitle.",
"Use this block to add a Download section.",
"Title.",
"Use this block to add a new feature/image.",
"Section top padding",
"Specify what form of top padding should the section use.",
"Section bottom padding",
"Specify what form of bottom padding should the section use.",
"Area Chart",
"Graph labels",
"Graph labels, comma separated.",
"Add one or more graphs",
"Add New Graph",
"Action",
"What We Do",
"Use this block to add a What We Do section.",
"Panel Icon.",
"Panel title.",
"Strategy",
...
"Minimal slider height.",
"Use this block to add a Slider section.",
"Background of the slide.",
"Use this block to add a slide to the slider.",
"Title Layer",
"Subtitle.",
"Horizontal position",
"Horizontal alignment of the layer. Acceptable values: center, left, right or any numeric value.",
"Vertical position",
"Vertical alignment of the layer. Acceptable values: center, top, bottom or any numeric value.",
"Horizontal offset",
"Horizontal offset of the layer. Acceptable values: any numeric value.",
"Vertical offset",
"Vertical offset of the layer. Acceptable values: any numeric value.",
"Animation speed",
"Speed at which layer enters the scene.",
"Entry delay",
"After how many milliseconds should this layer show up.",
"Use this block to add a new title layer to the slide.",
"Use this block to add a new image layer to the slide.",
"Process",
"The process.",
...
"Planning",
"Slide label.",
"Use this block to add a new Process item.",
"Add a Portfolio Grid section showing projects in the grid format.",
"Clients",
"The clients",
"Use this block to add a Client section.",
"Client",
"Client link.",
"Client logo.",
"Team Member",
"Capability",
"UX Design.",
"Use this block to add a new capability.",
"Capabilities",
"Our capabilities.",
"Use this block to add a Capabilities section.",
...
"Contact Form Title",
"Title displayed above the footer contact form",
"Contact.",
"Contact Form Subtitle",
"Subtitle displayed above the footer contact form",
"What can we help you with?",
"Map Latitude",
"Latitude of the location you want pinned on the map. Leave empty to not show the map.",
"Map Longitude",
"Longitude of the location you want pinned on the map. Leave empty to not show the map.",
"Social Network Name",
"Copyright",
"This is the header copyright message.",
"This is the footer copyright message.",
"Splash",
"Select the type of spash you need",
"App",
"Dashboard",
"Standard",
"Splash title",
...
"Button #1 url",
"Button #1 design",
"Choose between two available button designs",
"Filled",
"Transparent",
"Button #1 icon",
"Select optional button icon",
"Button #2 text",
"Button #2 url",
"Button #2 design",
"Button #2 icon",
"Splash image",
"Upload image displayed in the splash area",
"Splash background image",
"Image displayed in the background of the splash area",
"Splash background color",
"Background color of the splash area",
"Background Video (YT only)",
"Previously created video. YouTube only (Vimeo is not supported).",
"Gallery used for splash area. Captions can be added on the gallery edit screen.",
"Don't use video background",
"Contact form",
"Choose whether to display contact form on this page or not.",
"Show",
"Something went wrong, please try again.",
"Username you entered is not valid.",
"Email you entered is not valid.",
"Registration completed. The password will be sent to your email.",
