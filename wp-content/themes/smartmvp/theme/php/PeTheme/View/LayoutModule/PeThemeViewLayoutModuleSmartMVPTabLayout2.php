...
class PeThemeViewLayoutModuleSmartMVPTabLayout2 extends PeThemeViewLayoutModule {
		...
		return
			array(
				  ...
				  array(
						...
						'default'     => 'Multiple Layout<br> Options',
						),
				  'icon' => 
				  array(
	...
	public function name() {
		return __( 'Layout 2' ,'Pixelentity Theme/Plugin');
	}
	...
	public function template() {
		peTheme()->get_template_part( 'viewmodule', 'tab-layout2' );
	}

	public function tooltip() {
		return __( 'Text with icons and a big image (left).' ,'Pixelentity Theme/Plugin');
	}
