...
class PeThemeViewLayoutModuleSmartMVPTeamMembers extends PeThemeViewLayoutModuleContainer {
		...
		return
			array(
				...
				array(
					  ...
					  'default'     => 'We are a passionate team of designers, developers and marketing experts with headquarters in Melbourne.'
					  ),
				'bgcolor' => array(
	...
	public function template() {
		peTheme()->get_template_part( 'viewmodule', 'team' );
	}
